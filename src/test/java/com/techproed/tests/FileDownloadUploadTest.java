...
public class FileDownloadUploadTest extends TestBase {
    ...
    public void dosyaVarMi(){
        ...
        // C:\Users\isimsiz\IdeaProjects\SeleniumReviewTestNG\pom.xml
        boolean varMi = Files.exists(Paths.get("D:\\SeleniumReviewTestNG\\pom.xml"));
    ...
    public void dosyaUpload(){
        ...
        chooseFile.sendKeys("C:\\Users\\mhmty\\Desktop\\logo.png");
    ...
    public void dosyaIndirme(){
        ...
        boolean varMi = Files.exists(Paths.get("C:\\Users\\mhmty\\Downloads\\Penguins.jpg"));
        Assert.assertTrue(varMi);
    }
}
